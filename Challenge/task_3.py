...
def go_to_color(robot, color_list, ground_cam_left):
    for i in color_list:
        target_color = i
        print ("Next point is : {}".format(i))

        print ("Color {} searching".format(i))
        robot.turn(15)
        time.sleep(0.1)
...
def doTask(robot: FMLRobot, mqtt: FMLMqtt, camera: FMLCamera):
    ...
    while True:
        ...
        ground_cam_left = go_to_color(robot, color_list, ground_cam_left)


# def go_to_color(robot, color_list):
#     for i in color_list:
#         target_color = i
